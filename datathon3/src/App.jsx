      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full p-2 border h-[40vh] rounded h-32"
            required
          />
        </div>
      ...
      {analytics && (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
          <div className="bg-white p-4 rounded shadow">
            ...
            <p className="text-2xl">{analytics.total_tickets}</p>
          </div>
          <div className="bg-white p-4 rounded shadow">
          ...
          <div className="bg-white p-4 rounded shadow">
            ...
            <p className="text-2xl">{analytics.avg_resolution_time.toFixed(1)} hrs</p>
          </div>
        </div>
      )}
